...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || null, // 是否显示切换主题按钮
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Product display',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lovable', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Product display', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wa.me/18453666611', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Lovable', // 网站关键词 英文逗号隔开
  ...
  CUSTOM_RIGHT_CLICK_CONTEXT_MENU: process.env.NEXT_PUBLIC_CUSTOM_RIGHT_CLICK_CONTEXT_MENU || null, // 自定义右键菜单，覆盖系统菜单
